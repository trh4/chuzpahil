...
const seedConfessions = [
  {
    ...
    title: "הצמיד",
    content:
      "היינו בפארק מים בפוקט והיה לנו צמיד Fast Pass שהיה תקף רק למתקן אחד. מהר גילינו שאף אחד לא באמת בודק למה הוא תקף, אז פשוט הראינו אותו בכל תור. אנשים ראו את הצמיד ונתנו לנו לעקוף בלי לשאול שאלות.",
    country: "תאילנד",
    topic: "קומבינה",
  ...
  },
  {
    ...
    title: "ספלים למזכרת",
    content:
      "אני ואשתי אוספים ספלים. בטיול בברצלונה התאהבנו בשני ספלים באחד מבתי הקפה שהיינו בהם, אבל אי אפשר היה לקנות אותם. אז בלי שאף אחד שם לב, שטפתי אותם בשירותים ולקחתי אותם איתנו בתיק.",
    country: "ספרד",
    topic: "גניבה",
    tags: ["גניבה", "ספרד"],
  ...
  },
  {
    ...
    title: "נעליים",
    content:
      "בדירה ששכרתי בחו״ל ביקשו לא להיכנס עם נעליים כדי לא להפריע לעסק שמתחת. נכנסתי איתן בכל זאת, גם כי חששתי שייגנבו אם אשאיר אותן בחוץ וגם כי לא ייחסתי חשיבות לבקשה.",
    country: "אחר",
    topic: "אחר",
    tags: ["אחר"],
  ...
  },
  {
    ...
    title: "הרכבת",
    content:
      "הייתי בגרמניה ונסעתי ברכבת התחתית. לא ידעתי איך לקנות כרטיס במכונה. ביקשתי עזרה מאנשים אך זה לא הסתדר, ומפה לשם נסעתי ללא תשלום לזמן לא מבוטל מהחופשה.",
    country: "גרמניה",
    topic: "גניבה",
    tags: ["גרמניה", "גניבה"],
  ...
  },
  {
    ...
    title: "ירח דבש",
    content:
      "כל פעם שאני ואשתי טסים לחו״ל ובעיקר למזרח, אנחנו משקרים שזה ירח הדבש שלנו, גם כמה שנים טובות אחרי החתונה. אנחנו תמיד מקבלים בזכות זה הרבה הטבות כמו סוויטות משודרגות חינם ובקבוקי שמפניה לחדר.",
    country: "תאילנד",
    topic: "קומבינה",
    tags: ["תאילנד", "קומבינה"],
  ...
  },
  {
    ...
    title: "גוזלמה",
    content:
      "כשהייתי קטנה הייתי במלון הכל כלול בטורקיה. בבופה של ארוחת הבוקר היה מאכל טורקי בשם גוזלמה, ותמיד היה אליו תור ענק. לי ולאחים שלי נמאס, אז השתחלנו להתחלה.",
    country: "טורקיה",
    topic: "תור",
    tags: ["טורקיה", "תור", "קומבינה"],
  ...
  },
  {
    ...
    title: "חדר חסכוני",
    content:
      "בטיול הגדול אמרנו שאנחנו ארבעה בחדר, ובסוף הבאנו מזרונים והיינו יותר. המטרה הייתה לחסוך בכסף. באותו רגע הרגשתי עם זה די בסדר, ועכשיו קצת פחות.",
    country: "טיול גדול",
    topic: "קומבינה",
